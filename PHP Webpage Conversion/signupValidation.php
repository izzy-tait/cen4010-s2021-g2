        ...
        <header class="masthead">
			...
			<?
				if ($_SERVER["REQUEST_METHOD"] == "POST") {
					...
					$sqlcode = "call DEV_PROFILE_IF_USERNAME_EXISTS('$username',@validate);";
					...
					if($row["DOES_EXIST"] == 0){
						...
						echo "<div class='masthead-subheading'>Profile Created For:<br><br>Username: ".$row2["MEMBER_ID"]."<br>Please press the login in button below to login in.</div>";
						echo "<br><a class='btn btn-primary btn-xl text-uppercase js-scroll-trigger' href='login.php'>Log In</a>";
						$db2->close();
					}
					else {					
						echo "<div class='masthead-subheading'>Hi $firstname<br><br>The Username,$username, is already in use. Please try another user name or login with $username.</div>";
						echo "<div class='masthead-heading text-uppercase'></div>";
						echo "<br><a class='btn btn-primary btn-xl text-uppercase js-scroll-trigger' href='login.php'>Log In</a>";
					}
				}
				else{
