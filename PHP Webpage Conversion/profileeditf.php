...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Edit Profile Page if failure" />
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase"><br>Profile Edit</h2>
                    <h3 class="section-subheading text-muted"><span style="color:red;font-weight:bold;">The username selected is already in use. Please choose another.</span><br>Please Complete the form below to edit your profile.</h3>
                </div>
					<center>
