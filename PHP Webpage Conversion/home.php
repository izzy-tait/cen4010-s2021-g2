                ...
                <div class="text-center">
					<?
						if (!isset($_SESSION["MEMBER_NUMBER"])) {
							...
							echo "<span class='fa-stack fa-4x'><i class='fas fa-circle fa-stack-2x text-primary'></i><i class='far fa-user fa-stack-1x fa-inverse'></i></span><br><br><h2 class='section-heading text-uppercase'>Welcome!<br>$firstname $lastname</h2>";
						}
						...
						<table border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td align="left"  valign="top">
									<p class="text-muted">
										Quizzes Created: <? echo $numquizcreated;?><br>
										Quizzes Passed: <? echo $numquizpassed;?><br>
										Quizzes Not Passed: <? echo $numquizfailed;?><br>
										Quizzes Completed:  <? echo $numquiztaken;?>										
									</p>
								</td>
							</tr>
						</table>
						<br>
						<a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="quizhome.php">Go To Quiz Home</a>
						<a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="profileedit.php">Edit Profile</a>
					</center>
                </div>
            </div>
        </section>
